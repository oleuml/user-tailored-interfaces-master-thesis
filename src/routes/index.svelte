...
<div class="flex flex-col h-screen">
  ...
  <article class="p-2">
    ...
    <p>
            Vielen Dank erstmal, dass Du den Weg hierher gefunden hast. Im Rahmen meiner
            Masterarbeit führe ich diese Studie durch. Die Studie dauert durchschnittlich ca. 15
            min.
    </p>
  </article>
</div>
...
<a
  href="/survey"
  class="box active:text-green-600 active:bg-green-200 text-white bg-green-400 text-center font-bold"
  >Studie starten.</a
>
